...
import com.sparesparts.controller.customer.CusomerCartController;
...
class CusomerCartControllerTest {

    @Mock
    private CartService cartService;

    @InjectMocks
    private CusomerCartController cusomerCartController;
    ...
    void testAddOrUpdateCart() {
        ...
        ResponseEntity<Cart> response = cusomerCartController.addOrUpdateCart(cart);
    ...
    void testGetCart() {
        ...
        ResponseEntity<Cart> response = cusomerCartController.getCart(userId);
    ...
    void testRemoveFromCart() {
        ...
        ResponseEntity<Cart> response = cusomerCartController.removeFromCart(userId, productId);
    ...
    void testClearCart() {
        ...
        ResponseEntity<Cart> response = cusomerCartController.clearCart(userId);
