...
@RestController
@RequestMapping("/api/mechanic/{userId}/saved-addresses")
public class MechanicSavedAddressController {
    private final SavedAddressService savedAddressService;
    private final UserService userService;

    @Autowired
    public MechanicSavedAddressController(SavedAddressService savedAddressService, UserService userService) {
