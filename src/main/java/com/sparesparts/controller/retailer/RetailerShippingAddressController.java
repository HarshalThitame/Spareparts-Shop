...
@RestController
@RequestMapping("/api/retailer/shipping-addresses")
public class RetailerShippingAddressController {

    private final ShippingAddressService shippingAddressService;

    @Autowired
    public RetailerShippingAddressController(ShippingAddressService shippingAddressService) {
