...
@RestController
@RequestMapping("/api/customer/{userId}/saved-addresses")
public class CustomerSavedAddressController {
    private final SavedAddressService savedAddressService;
    private final UserService userService;

    @Autowired
    public CustomerSavedAddressController(SavedAddressService savedAddressService, UserService userService) {
